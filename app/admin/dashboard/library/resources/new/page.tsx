...
export default function NewLibraryResourcePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: "Library resource created successfully",
      })
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">New Library Resource</h1>
          <p className="text-gray-500">Add a new resource to the library</p>
        </div>
      </div>
