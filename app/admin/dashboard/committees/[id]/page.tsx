  ...
  useEffect(() => {
    async function fetchCommittee() {
      try {
        ...
        toast({
          title: "Error",
          description: "Failed to load committee data. Please try again.",
          variant: "destructive",
        })
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(error.error || "Failed to update committee")
      }
    ...
    <div className="space-y-6">
      <div className="flex items-center">
        ...
        <div>
          ...
          <p className="text-gray-500">Update committee details and members</p>
        </div>
      </div>
